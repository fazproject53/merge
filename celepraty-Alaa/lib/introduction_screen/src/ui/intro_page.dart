...
import 'package:celepraty/introduction_screen/src/ui/intro_content.dart';
...
class _IntroPageState extends State<IntroPage>
  ...
  Widget _buildFlex(context) {
    ...
    return Container(
      ...
      child: Flex(
        direction: widget.page.useRowInLandscape && orientation == Orientation.landscape
        ...
        children: [
          ...
          Expanded(
            ...
            child: Align(
              ...
              child: widget.page.useScrollView ? SingleChildScrollView(
                controller: widget.scrollController,
                physics: const BouncingScrollPhysics(),
