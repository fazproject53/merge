                ...
                Column(
                    ...
                    children: [
                      ...
                      paddingg(
                        ...
                        15,
                        12,
                        textFieldNoIcon(context, 'الاسم', 12, false, name,
                            (String? value) {
                      ...
                      paddingg(
                        ...
                        12,
                        textFieldNoIcon(
                            context, 'البريد الالكتروني', 12, false, email,
                            (String? value) {
                          if (value == null || value.isEmpty) {
                            return 'Please enter some text';
                          }
                      ...
                      paddingg(
                        ...
                        12,
                        textFieldNoIcon(
                            context, 'كلمة المرور', 12, true, password,
                            (String? value) {
                          if (value == null || value.isEmpty) {
                            return 'Please enter some text';
                          }
                      ...
                      paddingg(
                        ...
                        15,
                        12,
                        textFieldNoIcon(context, 'رقم الجوال', 12, false, phone,
                            (String? value) {
                          if (value == null || value.isEmpty) {
                            return 'Please enter some text';
                          }
                      ...
                      paddingg(
                        ...
                        12,
                        textFieldNoIcon(
                            context, 'رابط الصفحة', 14, true, pageLink,
                            (String? value) {
                          if (value == null || value.isEmpty) {
                            return 'Please enter some text';
                          }
                      ...
                      textFeildWithButton(
                        ...
                        gradientContainerWithHeight(
                          ...
                          Center(
                              child: InkWell(
                                  onTap: () {},
                                  child: text(context, 'اضافة', 14, white,
