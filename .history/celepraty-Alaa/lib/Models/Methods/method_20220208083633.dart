...
Widget drowFolldingCell(Key?key,double height,double left,double right,double top,double bottom,Widget frontWidget,Widget innerWidget){
return SimpleFoldingCell.create(
          key: key,
          frontWidget: frontWidget,
          innerWidget: innerWidget,
          cellSize: Size(double.infinity, height.h),
          padding: const EdgeInsets.only(left:left.w, right:right.w, top:top.h, bottom:bottom.h),
