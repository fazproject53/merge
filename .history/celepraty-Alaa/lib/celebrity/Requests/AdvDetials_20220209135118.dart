...
//accapt buttom-----------------------------------------------------
        Expanded(
          ...
          child: Row(children: [
            Expanded(
              child: Icon(Icons.check_box, color: pink,size: 40.sp),
            ),
            divider(
              endIndent: 10
            ),
            Expanded(
              child: Icon(Icons.disabled_by_default_rounded, color: pink,size: 40.sp),
            ),
              divider(),
            Expanded(
              child: Icon(Icons.textsms_outlined, color: pink,size: 40.sp),
            )
          ]
